...
export default function TaskPopupCard({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md overflow-hidden rounded-xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)]"
      ...
      >
        ...
        <div className="flex items-start justify-between px-6 pb-3 pt-5">
          <div className="flex flex-1 items-start gap-3 pr-4">
            {/* Color indicator */}
            <div className="mt-1.5 h-3 w-3 flex-shrink-0 rounded-sm bg-blue-500" />

            {/* Task title */}
            <h2
              id="task-title"
              className="flex-1 text-[22px] font-normal leading-7 text-gray-900"
            >
              {task.title}
            </h2>
          </div>
        ...
        <div className="space-y-3 px-6 pb-4">
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            <span className="text-[14px] leading-5 text-gray-800">
          ...
          {/* Project section */}
          <div className="flex items-center gap-4 py-2">
            <List className="h-5 w-5 flex-shrink-0 text-gray-600" />
            <span className="text-[14px] leading-5 text-gray-800">
              Calendar Tasks
            </span>
          </div>
          ...
          {/* Task list section */}
          <div className="flex items-center gap-4 py-2">
            <CheckSquare className="h-5 w-5 flex-shrink-0 text-gray-600" />
            <span className="text-[14px] leading-5 text-gray-800">
              My Tasks
            </span>
          </div>
